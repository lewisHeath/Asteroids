...
public class GameArena extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener
{
	...
	/**
	 * Set the background of the GameArena window to the specified image file. The
	 * image will be scaled to fit the size of the GameArena
	 *
	...
	public void mousePressedOnStriker(MouseEvent e){
